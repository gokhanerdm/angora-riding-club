  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto"
      ...
      <div className="flex items-center gap-3 px-4 pt-14 pb-4 sticky top-0"
        ...
        <h2 className="font-bold">Eğitmen Profili Düzenle</h2>
      </div>

      <div className="px-4 py-5 space-y-4 pb-24">
        <div className="rounded-2xl p-4 space-y-4" style={{ background: 'rgba(27,59,47,0.05)', border: '1px solid rgba(27,59,47,0.10)' }}>
          <div className="grid grid-cols-2 gap-3">
            <div><p className="text-xs mb-1 font-bold" style={{ color: 'rgba(27,59,47,0.55)' }}>Ad</p>
            ...
            <div><p className="text-xs mb-1 font-bold" style={{ color: 'rgba(27,59,47,0.55)' }}>Soyad</p>
          ...
          <div><p className="text-xs mb-1 font-bold" style={{ color: 'rgba(27,59,47,0.55)' }}>Prim Oranı (%)</p>
              ...
              {SHIFT_OPTIONS.map(s => (
                <button key={s.value} onClick={() => setShift(s.value)}
                  ...
                  style={shift === s.value
                    ...
                    : { background: 'rgba(27,59,47,0.06)', border: '1px solid rgba(27,59,47,0.10)', color: '#1B3B2F' }}>
                  {s.label}
                </button>
              ))}
            </div>
