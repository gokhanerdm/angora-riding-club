-- create_direct_membership admin tarafindan cagrilir (legacy/pasif uyeler).
-- Onceden p_used_lessons=0 ise actual_start_date/end_date NULL birakiliyordu,
-- bu da UI'da "Ilk dersinizi alin" gostermesine yol aciyordu.
-- Admin zaten baslangic tarihini biliyor; hemen aktiflestirilmeli.
